		  ...
		  <?php $notice_obj->Notify();?> 
			...
			<?php } ?>		
						...
						switch($index)
						{
							...
							break;
							case 'checkIn' :
							$reservation_obj->GuestCheckIn($res_id);
							break;
							case 'checkOut' :
                            if($submitPayment=='Generate Bill')
							$reservation_obj->GuestcheckOut('server',$res_id);
                            else
                            $reservation_obj->GuestcheckOut('local',$res_id);
							break;
							default:
							?>
							<div id="popupdiv">
