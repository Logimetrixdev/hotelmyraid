...
require_once('class/class.KotMenus.php');
...
<div class="container-fluid" id="pcont">
     ...
     switch($index)
	{
		case 'new_header':
		if($submit=='Save Info')
		$kot_obj->New_Header_Category('server');	
		else
		$kot_obj->New_Header_Category('local');
		break;
		case 'new_item':
		if($submited=='Save Info')
		$kot_obj->New_Item_In_Category('server');	
		else
		$kot_obj->New_Item_In_Category('local');
	 	break;
		case 'editItem':
		if($submited=='Edit Info')
		$kot_obj->EditItems('server',$itemId);	
		else
		$kot_obj->EditItems('local',$itemId);
	 	break;
		case 'editMenuHeader':
		if($submited=='Edit Info')
		$kot_obj->EditHeader('server',$headerId);	
		else
		$kot_obj->EditHeader('local',$headerId);
	 	break;
		default :
		$kot_obj->AllKOTMenuList();
		break;
	}
	?>
	</div>
