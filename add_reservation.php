...
<div class="container-fluid" id="pcont">
   ...
   switch($index)
	...
	case 'new':
		...
		break;
	case 'payment':
		if($submitPayment=='Pay Now')
		$reservation_obj->PaymentSection('server',$guestid,$reservationid);	
		else
		$reservation_obj->PaymentSection('local',$guestid,$reservationid);
		break;
	case 'EditInfo':
		if($submited=='Edit Info')
		$reservation_obj->EditSection('server',$res_id);	
		else
		$reservation_obj->EditSection('local',$res_id);
		break;
	case 'listings':
	...
	case 'edit':
	if($update=='Proceed')
		$reservation_obj->Edit_Reservation('server',$res_id);	
		else
		$reservation_obj->Edit_Reservation('local',$res_id);
		break;
