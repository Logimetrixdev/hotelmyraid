...
require_once('class/class.masterTaxes.php');
$auth=new Authentication();
$auth->CheckAdminlogin();
$layout_obj = new DesignLayout();
$notice_obj = new Notification();
$controller = 'OtherSettings';
$action = 'TaxManagement';
$tax_obj = new MasterTaxClass();
$ajax = new PHPLiveX();
$ajax->AjaxifyObjects(array("tax_obj")); 
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container-fluid" id="pcont">
   ...
   switch($index)
	...
	case 'editTax':
		if($tax_id!='')
		{
		$tax_obj->EditTaxValues($tax_id);	
		}
		break;
	break;
	default :
		echo $tax_obj->TaxValuesManagement();
		break;
	}
	?>
	</div>
