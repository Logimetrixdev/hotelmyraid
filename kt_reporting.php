...
$controller = 'Report';
$action = 'Kt';
$reportKt_obj = new HotelReportsKOT();

$ajax->AjaxifyObjects(array("reportKt_obj"));  
?>
<!DOCTYPE html>
<html lang="en">
...
?>
	...
	{
	case 'sales' :
    $reportKt_obj->KOTReportFilter($kot_for,$room_no_id,$report_date,$kot_type);
	break;
	
	default:
	$reportKt_obj->KOTReportFilter($kot_for,$room_no_id,$report_date,$kot_type);
	$reportKt_obj->SalesKOTReport($kot_for,$room_no_id,$report_date,$kot_type);
	break;
	}
