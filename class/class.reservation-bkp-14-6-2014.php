...
<select class="form-control" name="country_id" required onchange="reservation_obj.ChangeState(this.value,{target:'refstatelisting',preloader:'pr3'})">
              ...
              <label>Zip Code</label> 
				 <input  type="text" name="zipcode" value="<?php echo $_REQUEST['zipcode']?>" class="form-control"   placeholder="Type something" />
	         </div>
			  <div class="col-sm-4" style="padding-right: 6px;padding-left: 1px;">
              <label>Email</label> 
			  ...
			  <div class="col-sm-4" style="padding-right: 6px;padding-left: 1px;">
              <label>ID Type</label> 
				 	<?php $this->Master->Identfication_Type();?>
	         </div>
			  <div class="col-sm-4" style="padding-right: 6px;padding-left: 1px;">
              <label>ID Number</label> 
			  <input data-parsley-type="alphanum" name="identification_number" value="<?php echo $_REQUEST['identification_number']?>" type="text" class="form-control" required placeholder="Type something" />
			  </div>
			  <div class="col-sm-4" style="padding-right: 6px;padding-left: 1px;">
              <label>Expiry Date</label> 
			 <div class="input-group date datetime" data-min-view="2" data-date-format="yyyy-mm-dd">
                    <input class="form-control" size="16" name="identity_exp_date" value="<?php echo $_REQUEST['identity_exp_date']?>" type="text"  readonly>
	...
	<select class="form-control" name="child_count" required onchange=" reservation_obj.checkoccupany(this.form.occupancy.value,this.form.no_of_room.value,this.form.adult_count.value,this.value,this.form.child_age.value,this.form.extra_bed.value,{target:'checkoccupanyref'})" >
            ...
            <select class="form-control" name="extra_bed" onchange="reservation_obj.checkoccupany(this.form.occupancy.value,this.form.no_of_room.value,this.form.adult_count.value,this.form.child_count.value,this.form.child_age.value,this.value,{target:'checkoccupanyref'})" >
			 ...
			 <div class="form-group">
			  ...
			  <h4 style="font-weight:600">Booking Source:-</h4>
			  <div class="form-group">
                <div class="col-sm-12"  style="padding-bottom:15px;">
				  <label class="radio-inline"> <input type="radio" value="1" checked=""  name="booking_source_id"> Front Desk</label> 
                </div>
              </div>
    ...
    padding-bottom: 26px;">
		...
		if($this->Form->ValidField($booking_type,'empty','Please Select Booking Type')==false)
			$return =false;
			    ...
			    /*$sql = "select * from ".INFINITE_USER." where username='".$this->username."'";
			...
			*/
			...
			if($return){
							...
							$insert_sql_array['zipcode'] = $this->zipcode;
							...
							$insert_sql_array3['guest_id'] = $guest_id;
							$insert_sql_array3['reservation_id'] = $reservation_id;
							$insert_sql_array3['identification_id'] = $this->identification_id;
							$insert_sql_array3['identification_number'] = $this->identification_number;
							$insert_sql_array3['identity_exp_date'] = $this->identity_exp_date;
							$insert_sql_array3['identify_country_id'] = $this->identify_country_id;
							$insert_sql_array3['identify_state_id'] = $this->identify_state_id;
							$insert_sql_array3['identify_city_id'] = $this->identify_city_id;
							$insert_sql_array3['image_path'] = $this->image_path;
						    $this->db->insert(HMS_GUEST_IDENTIFICATION,$insert_sql_array3);
							
							/*$insert_sql_array4 = array();
							$l=0;
							foreach($product as $value)
							{
								$insert_sql_array4['guest_id'] = $guest_id;
								$insert_sql_array4['reservation_id'] = $reservation_id;
								$insert_sql_array4['addons_id'] = $value[$i];
								$insert_sql_array4['amount'] = $this->Master->TotalCostPerAddOns($value[$i],$total_no_of_person,$this->no_of_nights);
								$this->db->insert(HMS_GUEST_ADDONS,$insert_sql_array4);
								$l++;
							}*/
...
<select class="form-control" name="country_id" required onchange="reservation_obj.ChangeState(this.value,{target:'refstatelisting',preloader:'pr3'})">
	...
	function PaymentSection($runat,$guestid,$reservationid)
	{
		switch($runat)
		{
			...
			$FormName = "form_payment";
							...
							$ValidationFunctionName="CheckAddpaymentValidity";
	...
	<div class="col-md-12">
				...
				<td class="text-center"><?php echo $this->Master->ExtraBedPriceOnReservation($reservationid);?></td>
								   ...
								   ?>
									...
									<td class="text-center"><strong>Any Discount:-</strong></td>
									 ...
									 <input type="text" name="discount" onchange="javascript:getpayableamount(this.form.main_cost.value,this.value);" onkeyup="javascript:getpayableamount(this.form.main_cost.value,this.value);"  data-parsley-type="number" value="0" class="form-control" style="width:120px;" required/></td>
								</tr>
                                <tr>
									<td></td>
								    <td></td>
                                 ...
                                 <tr>
								   ...
								   function check_lux(total)
									...
									if (elem.checked == true) {
										 stotal += Math.round(Number(total*elem.value/100));
										 if (elem.checked == true && i==1) 
										 
										 document.getElementById('lux_tax').value= Math.round(total*elem.value/100);
										 }
										 if(elem.checked == true && i==2)
										 {
											 document.getElementById('ser_tax').value= Math.round(total*elem.value/100);
										 }
									}
									
									var toatlamt = parseInt(stotal) + parseInt(total);
									...
									document.getElementById('totalamtwithTax').value= Math.round(toatlamt);
                                    ...
                                    <tr>
                                        ...
                                        <?php
										$x=1;
				$sql_tax="select * from ".HMS_TAXS." where id!='3'";
				...
				?>
                                    ...
                                    <input type="hidden" id="ser_tax" name="ser_tax" value="" /></td>
								    <td><input type="hidden" id="service_charge" name="service_charge" value="" /></td>
									<td class="text-center"><strong>Round Off Amount:-</strong></td>
									 <td class="text-center" colspan="2">
									 <input type="text" id="totalamtwithTax" value="<?php echo round($this->Master->TotalPayAableAmount($this->Master->TotalProductCost($reservationid)));?>" class="form-control" name="total_amount" readonly="readonly" style="width:120px;" placeholder="0.00"> 
									 </td>
								</tr>
								<tr>
                    ...
                    <option value="Credit/Debit Card">Credit/Debit Card</option>
								...
								<tr>
									...
									<td class="text-center"><strong>Balance Amount:-</strong></td>
									 <td class="text-center" colspan="2">
									 <input type="text"   id="amount_left" name="remain_amount" data-parsley-type="digits" placeholder="0.00" class="form-control" readonly="readonly" value="" style="width:120px;"/></td>
								</tr>	
								</tbody>
							</table>		
							</div>
        ...
        <?php
			...
			$this->discount = $discount;
			 ...
			 //echo 'Lux Tax'.$this->tax1;
			 //echo 'Ser Tax'.$this->tax2;
			 // echo '<br/>';
			// echo 'Service Charge '.$this->service_charge;
			  //echo '<br/>';
			 //exit;
			$return = true;
		...
		if($this->Form->ValidField($payment_mode,'empty','Please select any payment mode')==false)
			...
			if($return){
							...
							//$insert_sql_array['addons_price'] = $this->Master->AllAddOnsCostForPayment($reservationid);
							if($this->tax1!='')
							{
							...
							if($service_charge!='')
							{
							$insert_sql_array['service_charge'] = $this->service_charge;
							}
						...
						$this->db->insert(HMS_RESERVATION_PAYMENTS,$insert_sql_array);
						    ...
						    $_SESSION['msg'] = 'Guest payment done successfully.';	
								...
								$this->objMail->AddAddress('abhimishrait@gmail.com');
							...
							if($row_2['service_charge']!=0)
							{
								$this->objMail->Body .= '<tr>
								<td>'.date('d-m-Y', strtotime($row_2['payment_date'])).'</td>
								<td>Service Charge</td>
								<td>'.$this->Master->GetTaxValue(4).'%</td>
								<td>'.round($row_2['service_charge']).'</td>
								<td>&nbsp;</td>
								</tr>';
							}
								...
								<th scope="col" width="25%">'.number_format($row_2['total_amount']+$row_2['discount']).' INR</th>
								...
								<th scope="col" width="25%"></th>
								<th scope="col" width="25%">'.number_format($row_2['advance_amount']).' INR</th>
								</tr>';
								$this->objMail->Body .= '<tr>
								<th scope="col" width="36%"></th>
								<th scope="col" width="25%">Discount</th>
								<th scope="col" width="25%"></th>
								<th scope="col" width="25%">'.number_format($row_2['discount']).' INR</th>
								</tr>';
								...
								<th scope="col" width="25%"></th>
								<th scope="col" width="25%">'.number_format($row_2['remain_amount']).' INR</th>
								</tr>';
								$this->objMail->Body .= '</table>';
								$this->objMail->Body .= '</div>';
								$this->objMail->Body .= '</div>';
...
/*	function addtaxes($tax_id1,$tax_id2,$tax_id3,$product_total)
				...
				<td class="text-center"><?php echo $this->Master->ExtraBedPriceOnReservation($row['reservation_id']);?></td>
							...
							if($row['tax1']!=0)
							{
								...
								<tr>
										...
										<td class="text-center"><?php echo round($row['tax1']);?></td>
										<td class="text-center"></td>
								</tr>
                              <?php
							}
							...
							if($row['tax2']!=0)
							{
								...
								<tr>
										...
										<td class="text-center"><?php echo round($row['tax2']);?></td>
										<td class="text-center"></td>
								</tr>
                              <?php
							}
	...
	function ReservationListing($first_name='',$last_name='',$phone='',$arrival='',$departure='',$room_type_id='')
	{
			...
			$sql="select * from ".HMS_GUEST_RESERVATION." where deleted='0'";
			 ...
			 $sql .= " order by check_in_status asc";
			...
			<div class="col-md-6 col-sm-5"><strong>Contact: </strong><?php echo $this->Master->FindGuestPhoneByGuestId($row['guest_id'])?> </div>
			<div class="col-md-6 col-sm-5"><strong>Adult/Child: </strong>  <?php echo $row['adult_count']?>/<?php echo $row['child_count']?></div>
			<div class="col-md-12 col-sm-5"><strong>Email: </strong><?php echo $this->Master->FindGuestEmailByGuestId($row['guest_id'])?></div>
			<div class="col-md-12 col-sm-5"><strong>Room Type: </strong> <?php echo $this->Master->RoomTypeByReservationId($row['id'])?></div>
			</div>
			</div>
			<div class="col-sm-4">
	...
	function GuestCheckIn($reservationId)
	{
		...
		?>
			...
			if($row['check_in_status']==0)
			{
				$FormName = "frm_check_in";
						$ControlNames=array("room_no"        =>array('room_no',"","kindly select room no.","span_room_no")
						);
		     ...
		     <div class="col-md-12 col-sm-5" style="margin-top:20px;">
                <form action="" method="post"  name="<?php echo $FormName;?>">
                    ...
                    $sql_room="select * from ".HMS_ROOM." where room_type_id='".$row['room_type_id']."' and assigned='0' and deleted='0'";
                    ...
                    ?>
                    <div class="col-md-6">
                    <strong>Select Room for Check-In: </strong>
                    <select name="room_no" class="form-control">
                     ...
                     <span style="color:#F00; font-weight:600;" id="span_room_no"></span>
                    </div>
                    <input type="button" name="submit" style="margin-top:22px;" class="btn btn-primary" value="Check-In" onclick=" if(<?php echo $ValidationFunctionName ?>()) { reservation_obj.guestCheck_in_update(this.form.room_no.value,'<?php echo $reservationId;?>',{}); } "/>
                    <?php
                    }
                    else
                    {
		...
		function GuestcheckOut($reservationid)
		{
				$sql="select * from ".HMS_RESERVATION_PAYMENTS." where reservation_id ='".$reservationid."'";
				$result = $this->db->query($sql,__FILE__,__LINE__);
				$row = $this->db->fetch_array($result);
	...
	<div class="col-md-12">
				...
				<td class="text-center"><?php echo $this->Master->ExtraBedPriceOnReservation($reservationid);?></td>
								...
								<tr>
									...
									<td class="text-center"><strong>Payable Amount:-</strong></td>
									 <td class="text-center" colspan="2">
									 <input type="text" value="<?php echo $row['remain_amount']	;?>" class="form-control" name="total_amount" readonly="readonly" style="width:120px;" placeholder="0.00"> 
									 </td>
								</tr>
                                <tr>
									<td></td>
									...
									<td class="text-center"><strong>F & B Amount(Included Tax):-</strong></td>
									 <td class="text-center" colspan="2">
									 <input type="text" value="" class="form-control" name="fb_amount"
                                     onkeyup="reservation_obj.calculatebilling(this.form.total_amount.value,this.value,this.form.paid_amount.value,{})" onblur="reservation_obj.calculatebilling(this.form.total_amount.value,this.value,this.form.paid_amount.value,{})" onclick="reservation_obj.calculatebilling(this.form.total_amount.value,this.value,this.form.paid_amount.value,{})" onkeydown="reservation_obj.calculatebilling(this.form.total_amount.value,this.value,this.form.paid_amount.value,{})"
                                      data-parsley-type="number" style="width:120px;" required placeholder="0.00"> 
									 </td>
								</tr>
								<tr>
									<td><strong>Payment Method:-</strong></td>
                    ...
                    <option value="Credit/Debit Card">Credit/Debit Card</option>
									...
									<td class="text-center"><strong>Paid Amount:-</strong></td>
									 <td class="text-center" colspan="2">
									 <input type="text" 
                                     onchange="reservation_obj.calculatebilling(this.form.total_amount.value,this.form.fb_amount.value,this.value,{})" placeholder="0.00" onkeyup="reservation_obj.calculatebilling(this.form.total_amount.value,this.form.fb_amount.value,this.value,{})" onblur="reservation_obj.calculatebilling(this.form.total_amount.value,this.form.fb_amount.value,this.value,{})" onclick="reservation_obj.calculatebilling(this.form.total_amount.value,this.form.fb_amount.value,this.value,{})" onkeydown="reservation_obj.calculatebilling(this.form.total_amount.value,this.form.fb_amount.value,this.value,{})" name="paid_amount" value="" data-parsley-type="number" value="" class="form-control" style="width:120px;" required/
                                      ></td>
								</tr>
								...
								<tr>
									...
									<td class="text-center"><strong>Balance Amount:-</strong></td>
									 <td class="text-center" colspan="2">
									 <input type="text" value="" placeholder="0.00"  id="amount_remain" name="remain_amount" data-parsley-type="number" placeholder="0.00" class="form-control" readonly="readonly" style="width:120px;"/></td>
								</tr>	
								</tbody>
							</table>		
							</div>
				...
				<div  style="float:right;">
                 <button class="btn btn-default">Cancel</button>
				  <button type="button" onclick="reservation_obj.savebillingdetails(this.form.total_amount.value,this.form.fb_amount.value,this.form.paid_amount.value,this.form.payment_mode.value,'<?php echo $reservationid;?>',{})" class="btn btn-primary" name="submitPayment" value="Generate Bill">Generate Bill</button>
				  </div>
                </div>
              </div>
			  </div>
	...
	function savebillingdetails($total_amount, $fb_amount, $paid_amount, $payment_mode, $revId)
	{
		ob_start();
		$amount_left=0;
		$totalbillingAmount=0;
		if($revId!='' and $paid_amount!='')
		{
				$sql="select * from ".HMS_RESERVATION_PAYMENTS." where reservation_id ='".$revId."'";
				$result = $this->db->query($sql,__FILE__,__LINE__);
				$row = $this->db->fetch_array($result);
				$OldTotalPayement = $row['total_amount'];
				$NewTotalPayment =  $OldTotalPayement+$fb_amount;
				$advance_paid = $row['advance_amount'];
				$total_paid = $advance_paid+$paid_amount;
				$rem_amount_left = $NewTotalPayment-$total_paid-$row['discount'];
				$update_sql_array = array();
				$update_sql_array['fandb_price'] = $fb_amount;
				$update_sql_array['total_amount'] = $NewTotalPayment;
				$update_sql_array['total_paid_amount'] = $total_paid;
				$update_sql_array['remain_amount'] = $rem_amount_left;
				$update_sql_array['fullpayment_mode'] = $payment_mode;
				$update_sql_array['fullpayment_date'] = date('Y-m-d h:i:s A');
				$this->db->update(HMS_RESERVATION_PAYMENTS,$update_sql_array,'reservation_id',$revId);
				
				$get_room_id = $this->Master->RoomIDByReservationId($revId);
				$update_sql_array2 = array();
				...
				$this->db->update(HMS_GUEST_RESERVATION,$update_sql_array3,'id',$revId);
	...
	function calculatebilling($total_amount, $fb_amount, $paid_amount)
	{
		ob_start();
		
		$amount_left=0;
		
		$amount_left = $total_amount+$fb_amount-$paid_amount;
		?>
		<script>
				...
				<td class="text-center"><?php echo $this->Master->ExtraBedPriceOnReservation($row['reservation_id']);?></td>
							...
							if($row['service_charge']!=0)
							{
								...
								<tr>
										<td><?php echo date('d-m-Y', strtotime($row['payment_date']));?></td>
										<td class="text-left">Service Charge</td>
										<td class="text-center"><?php echo $this->Master->GetTaxValue(4)?>% [Add On Room]</td>
										<td class="text-center"><?php echo round($row['service_charge']);?></td>
										<td class="text-center"></td>
								</tr>
                              <?php
							...
							if($row['fandb_price']!=0)
							{
								...
								<tr>
										...
										<td class="text-center">[N/A]</td>
										<td class="text-center"><?php echo $row['fandb_price'];?></td>
										<td class="text-center"></td>
								</tr>
                              <?php
							}
							?>
                               ...
                               <tr>
									<td><?php echo date('d-m-Y', strtotime($row['fullpayment_date']));?></td> 
								    <td><?php echo $row['fullpayment_mode'] ?></td>
									<td class="text-center"></td>
									<td class="text-center"></td>
									 <td class="text-center"><?php echo $row['total_paid_amount']-$row['advance_amount']?></td>
							   </tr>
							...
							<table class="table no-border hover">
								<thead class="no-border">
									<tr>
										...
										<th style="width:28%;" class="text-left"></th>
										<th  style="width:28%;" class="text-center"><strong>Total</strong></th>
										<th style="width:15%;" class="text-center"><strong><?php echo $row['total_amount']?> INR</strong></th>
										<th style="width:15%;" class="text-center"><strong><?php echo $row['total_paid_amount']?> INR</strong></th>
									</tr>
                                    <tr>
										<th style="width:14%;"></th>
...
<div style="width:190px; height:35px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> Rooms (<?php echo $this->Master->TotalBookedRoomsByReservationId($row['reservation_id']);?> <?php echo $this->Master->RoomTypeByReservationId($row['reservation_id']);?>)</p></div>
<div style="width:140px; height:35px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> [ NA Room ]</p></div>
<div style="width:90px; height:35px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; color:#000;" align="center"><?php echo number_format($this->Master->getRoomTotalAmount($row['reservation_id']));?></p></div>
...
<div style="width:190px; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> Bed Booked (<?php echo $this->Master->ExtraBedAllowed($row['reservation_id']);?>)</p></div>
<div style="width:140px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> [ NA Room ]</p></div>
<div style="width:90px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; color:#000;" align="center"><?php echo number_format($this->Master->ExtraBedPriceOnReservation($row['reservation_id']));?></p></div>
...
<div style="width:90px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; color:#000;" align="center"><?php echo number_format($row['tax1']);?></p></div>
<div style="width:90px; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> </p></div> 
</div>
 <?php
}
...
<div style="width:90px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; color:#000;" align="center"><?php echo number_format($row['tax2']);?></p></div>
<div style="width:90px; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> </p></div> 
</div>
 <?php
}
...
<div style="width:140px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> <?php echo $this->Master->GetTaxValue(4)?>%</p></div>
<div style="width:90px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; color:#000;" align="center"><?php echo number_format($row['service_charge']);?></p></div>
<div style="width:90px; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> </p></div> 
</div>
 <?php
}
...
<div style="width:140px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center">[N/A]</p></div>
<div style="width:90px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; color:#000;" align="center"><?php echo number_format($row['fandb_price']);?></p></div>
<div style="width:90px; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> </p></div> 
</div>
 <?php
}
...
<div style="width:610px; border:1.3px solid #666666; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:90px; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> <?php echo date('d-m-Y', strtotime($row['payment_date']));?></p></div>
<div style="width:190px; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> Advance Amount</p></div>
<div style="width:140px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"><?php echo $row['payment_mode']?></p></div>
...
<div style="width:140px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"><?php echo $row['fullpayment_mode']?></p></div>
<div style="width:90px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; color:#000;" align="center"></p></div>
<div style="width:90px; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> <?php echo number_format($row['total_paid_amount']-$row['advance_amount'])?></p></div> 
</div>
...
<div style="width:90px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; color:#000;" align="center"><?php echo number_format($row['total_amount'])?> INR</p></div>
<div style="width:90px; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> <?php echo number_format($row['total_paid_amount'])?> INR</p></div> 
</div>
...
<div style="width:90px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; color:#000;" align="center"></p></div>
<div style="width:90px; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> <?php echo number_format($row['discount'])?> INR</p></div> 
</div>
<div style="width:610px; border:2px solid #000000; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:90px; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"></p></div>
<div style="width:190px; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"></p></div>
<div style="width:140px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"><b>Balance</b></p></div>
<div style="width:90px; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; color:#000;" align="center"></p></div>
<div style="width:90px; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px; color:#000;" align="center"> <?php echo number_format($row['remain_amount'])?> INR</p></div> 
</div>
