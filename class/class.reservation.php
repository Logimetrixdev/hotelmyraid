...
class Reservation
{
	...
	function getprevious_date($res_id)
	{
		$sql="select * from ".HMS_GUEST_RESERVATION." where guest_id='".$res_id."'";
		$result = $this->db->query($sql,__FILE__,__LINE__);
	...
	function DaysCalculate1($id,$date1, $date2,$no_of_room,$room_type_id,$occupancy)
	{
	ob_start();
	
	
	$previous_date=$this->getprevious_date($id);
	
	
	
	if($date2<=$previous_date)
	{
	...
	$Cnt = $this->db->num_rows($result);
		if($Cnt<=0)
		{
				if($date1<=$date2)
				{
					...
					$amount=$this->Master->TotalRoomCost($no_of_room,$room_type_id,'1',$occupancy);
              ...
              <label>Amount</label>  
				  ...
				  <input type="text" value="<?php echo $amount?>" required class="form-control" name="amount" readonly="readonly">
				...
				<?php
				 ...
				 $amount=$this->Master->TotalRoomCost($no_of_room,$room_type_id,$dayscount,$occupancy);
				?>
                  <div class="form-group">
                 <div class="col-sm-6" style="padding-right: 6px;padding-left: 1px;">
              <label>No. of nights</label> <img id="pr5" src="img/status.gif" style="visibility:hidden; height:25px;"> 
              ...
              <label>Amount</label>  
				...
				{
					// $amount=$this->Master->TotalRoomCost($no_of_room,$room_type_id,'',$occupancy);
				?>
                  <div class="form-group">
                 <div class="col-sm-6" style="padding-right: 6px;padding-left: 1px;">
              <label>No. of nights</label> <img id="pr5" src="img/status.gif" style="visibility:hidden; height:25px;"> 
              ...
              <label>Amount</label>  
				  ...
				  <input type="text" value="" required class="form-control" name="amount" readonly="readonly">
	...
	function gettax1()
	{
		$sql_tax="select * from ".HMS_TAXS." where id='1'";
		$result_tax = $this->db->query($sql_tax,__FILE__,__LINE__);
		$row_tax = $this->db->fetch_array($result_tax);
		return $row_tax['percent_value'];
	}
	
	function gettax2()
	{
		$sql_tax="select * from ".HMS_TAXS." where id='2'";
		$result_tax = $this->db->query($sql_tax,__FILE__,__LINE__);
		$row_tax = $this->db->fetch_array($result_tax);
		return $row_tax['percent_value'];
	}
	...
	function Edit_Reservation($runat,$res_id)
	{
		$this->res_id=$res_id;
    	$sql="select * from ".HMS_GUEST_RESERVATION." where guest_id='".$this->res_id."'";
		$result = $this->db->query($sql,__FILE__,__LINE__);
		$row = $this->db->fetch_array($result);
		
		$this->no_of_room=$row['no_of_rooms'];
		$this->room_type_id=$row['room_type_id'];
		$this->no_of_nights=$row['no_of_nights'];
		$this->occupancy=$row['occupancy'];
		$amount=$this->Master->TotalRoomCost($this->no_of_room,$this->room_type_id,$this->no_of_nights,$this->occupancy);
		
		
		$sql_tax="select * from ".HMS_RESERVATION_PAYMENTS." where guest_id='".$this->res_id."'";
		$result_tax = $this->db->query($sql_tax,__FILE__,__LINE__);
		$row_tax = $this->db->fetch_array($result_tax);
		
		$this->base_price=$row_tax['base_price'];
		$this->total_paid_amount=$row_tax['total_paid_amount'];
		$this->total_amount=$row_tax['total_amount'];
		$this->remain_amount=$row_tax['remain_amount'];
		$this->extra_bed=$row_tax['extra_bed'];
		$this->discount=$row_tax['discount'];
		
		if($row_tax['tax1']!=0)
			$this->tax1=$row_tax['tax1'];
		else
			$this->tax1=0;
		
		if($row_tax['tax2']!=0)
			$this->tax2=$row_tax['tax2'];
		else
			$this->tax2=0;
		...
		switch($runat)
		{
			...
			case 'local':
			$FormName = "form_EditReservation";
							$ControlNames=array();
	
							$ValidationFunctionName="CheckEditValidity";
          ...
          <div class="content" style="padding-top:0px;">
             <h4 style="font-weight:600">Stay Information:-</h4>
              ...
              <label>Arrival</label> 
                    ...
                    <input class="form-control"  name="arrival"  disabled="disabled" size="16" type="text" value="<?php echo $row['arrival']?>" readonly >
              ...
              <label>Departure</label> 
			 <div class="input-group date datetime" data-min-view="2" data-date-format="yyyy-mm-dd">
                    <input class="form-control" name="departure" size="16" type="text" value="<?php echo $row['departure']?>" readonly onkeyup="reservation_obj.DaysCalculate1('<?php echo $this->res_id;?>',this.form.arrival.value,this.value,'<?php echo $this->no_of_room;?>','<?php echo $this->room_type_id;?>','<?php echo $this->occupancy;?>',{target:'refdays',preloader:'pr5'})" onchange="reservation_obj.DaysCalculate1('<?php echo $this->res_id;?>',this.form.arrival.value,this.value,'<?php echo $this->no_of_room;?>','<?php echo $this->room_type_id;?>','<?php echo $this->occupancy;?>',{target:'refdays',preloader:'pr5'})">
                    <span class="input-group-addon btn btn-primary"><span class="glyphicon glyphicon-th"></span></span>
                  </div>
			  </div>
			  ...
			  <div class="form-group" id="refdays">
              ...
              <label>No. of nights</label> <img id="pr5" src="img/status.gif" style="visibility:hidden; height:25px;"> 
				  ...
				  <input type="text" value="<?php echo $row['no_of_nights']?>" required class="form-control" name="no_of_nights" readonly="readonly">
              ...
              <label>Amount</label>  
				  ...
				  <input type="text" name="amount" value="<?php echo $amount?>" required class="form-control"  readonly="readonly">
         ...
         <div class="form-group">
			  ...
			  if($this->tax1!=0){
                ...
                <?php
                 ...
                 $sql_tax1="select * from ".HMS_TAXS." where id='2'";
                $result_tax1 = $this->db->query($sql_tax1,__FILE__,__LINE__);
                $row_tax1 = $this->db->fetch_array($result_tax1);
                
					
                ?>
                <p>
                 <?php echo $row_tax1['tax_name'];?> 
                [<?php echo $row_tax1['percent_value'].'%';?> ]</p>
    ...
    padding-bottom: 26px;">
                <div class="col-sm-offset-2 col-sm-10">
				  ...
				  <button type="submit" class="btn btn-primary" name="update" value="Proceed">Proceed >></button>
                </div>
              </div>
			 </div> 
			</div>
        ...
        <?php
			...
			$this->amount=$amount;
			 ...
			 if($this->tax1!=0)
			 {
			 	$this->tax=($this->amount+$this->extra_bed-$this->discount)*$this->gettax1()/100;
			 }
			
			 if($this->tax2!=0)
			 {
				 $this->service_tax=($this->amount+$this->extra_bed-$this->discount)*$this->gettax2()/100;
			 }
			
			if($this->base_price!=$this->amount)
			{
				$this->final_amount=$this->amount+$this->tax+$this->service_tax;
				$this->pending_amount=$this->final_amount-$this->total_paid_amount;
			}
		...
		if($this->departure>$this->getprevious_date($this->res_id))
		{
			$_SESSION['error_msg'] = 'Wroung Date Selection.';
			?>
			<script>
			window.location='add_reservation.php?index=edit&res_id=<?php $this->res_id;?>';
			</script>
			<?php
			exit();
		}
		...
		if($return){
							...
							//$update_sql_array['arrival'] = $this->arrival;
							$update_sql_array['departure'] = $this->departure;
							$update_sql_array['no_of_nights'] = $this->no_of_nights;
							
							$update_sql_array['total_room_cost'] = $this->amount;
							
							$this->db->update(HMS_GUEST_RESERVATION,$update_sql_array,'guest_id',$this->res_id);
							
							$update_sql_array = array();
							$update_sql_array['base_price'] = $this->amount;
							
							if($this->tax1!=0)
							{
								$update_sql_array['tax1'] =$this->tax;
							}
							if($this->tax2!=0)
							{
								$update_sql_array['tax2'] =$this->service_tax;
							}
							
							if($this->base_price!=$this->amount)
							{
								$update_sql_array['remain_amount'] =$this->pending_amount;
								
								$update_sql_array['total_amount'] =$this->final_amount;
								
							}
							
							
							$this->db->update(HMS_RESERVATION_PAYMENTS,$update_sql_array,'guest_id',$this->res_id);
							//$reservation_id = $this->db->last_insert_id();
							...
							echo $this->Form->ErrtxtPrefix.$this->Form->ErrorString.$this->Form->ErrtxtSufix; 
							$this->Edit_Reservation('local',$res_id);
							}
...
/*	function addtaxes($tax_id1,$tax_id2,$tax_id3,$product_total)
       ...
       <div class="block-flat" style="height:1250px;">
		  ...
		  <div class="col-md-12">
			...
			<div class="col-md-12" style="margin-top:25px;">
						...
						<p><strong>Cashier  :  </strong>  <?php echo ucwords($_SESSION['user_name']).' ['.$this->Master->GetUserLevelByUserTypeId($_SESSION['user_type']).' ]';?></p>
						</div>
						</div>
	...
	function ReservationListing($pg='',$recordcount='',$first_name='',$last_name='',$phone='',$arrival='',$departure='',$room_type_id='')
	{
		ob_start();
			...
			{
			?>
             <li><a href="add_reservation.php?index=edit&res_id=<?php echo $row['id'];?>">Previous Check-Out</a></li>
			 <?php }?>
            <?php } else {?>
            <li>
			...
			?>
			<li class="divider"></li>
			<li> <a  href="javascript: void(0);" title="Remove" onclick="javascript: if(confirm('Do u want to delete this Guset Reservation Info?')) { reservation_obj.deleteguest('<?php echo $row['id'];?>','<?php echo $row['room_id']?>',{}) };">Remove Guest</a></li>
            <?php
			}
			?>
			</ul>
	...
	function deleteguest($res_id,$room_id)
	{
		ob_start();
			...
			$this->db->update(HMS_GUEST_RESERVATION,$update_array,'id',$res_id);
                        ...
                        $update_array2 = array();
			$update_array2['assigned'] = 0 ;
		        $this->db->update(HMS_ROOM,$update_array2,'id',$room_id);
...
?>
			<div class="col-md-12 col-sm-5" style="margin-top:20px;">
                <form action="" method="post"  name="<?php echo $FormName;?>" enctype="multipart/form-data">
                    ...
                    ?>
						...
						<select class="form-control" name="nationality" onChange="reservation_obj.ChangeState(this.value,{target:'refstatelisting',preloader:'pr3'})">
  ...
  <option value="zimbabwean">Zimbabwean</option>
			 ...
			 <div class="input-group date datetime" data-min-view="2" data-date-format="yyyy-mm-dd">
                    <input class="form-control" size="16" name="dob" value="<?php echo $_REQUEST['dob']?>" type="text">
                    <span class="input-group-addon btn btn-primary"><span class="glyphicon glyphicon-th"></span></span>
                  </div>
			 ...
			 $this->image_path = $path;
						...
						if($return){
							...
							$update_sql_array['zipcode'] = $this->zipcode;
                                                        ...
                                                        $update_sql_array['nationality'] = $this->nationality;
				...
				<td class="text-center"><?php echo $this->Master->ExtraBedPriceOnReservation($reservationid);?></td>
								...
								<tr>
									...
									<td class="text-center"><strong>Remaining Balance:-</strong></td>
									 <td class="text-center" colspan="2">
									 <input type="text"  class="form-control" name="rem_amt" readonly="readonly" id="rem_amt" data-parsley-type="number" style="width:120px;" required placeholder="0.00" value="<?php echo number_format($row['remain_amount'],2);?>" /> 
									 </td>
								</tr>
                                <tr>
									<td></td>
				...
				<td class="text-center"><?php echo number_format($row['extra_bed'],2);?></td>
							...
							if($row['tax1']!=0)
							{
								...
								<tr>
										...
										<td class="text-center"><?php echo $this->Master->GetTaxValue(1)?>% <?php /*?>[Add On Room]<?php */?></td>
							...
							if($row['tax2']!=0)
							{
								...
								<tr>
										...
										<td class="text-center"><?php echo $this->Master->GetTaxValue(2)?>% <?php /*?>[Add On Room]<?php */?></td>
							...
							if($row['vat_fb']>0)
							{
								...
								<tr>
										...
										<td class="text-center"><?php echo $this->kt->GetVat();?> % <?php /*?>On F & B<?php */?></td>
							...
							if($row['sat_fb']>0)
							{
								...
								<tr>
										...
										<td class="text-center"><?php echo $this->kt->GetSat();?> % <?php /*?>On F & B<?php */?></td>
							...
							if($row['service_charge']!=0)
							{
								...
								<tr>
										<td><?php echo date('d-m-Y', strtotime($row['fullpayment_date']));?></td>
										<td class="text-left">Service Charge</td>
										<td class="text-center"><?php echo $this->Master->GetTaxValue(4)?>% <?php /*?>On Bill<?php */?></td>
...
<div style="width:950px; height:842px; padding-left:40px;" id="print">
...
<p style="font-family:Arial, Helvetica, sans-serif;font-size: 18px; margin: 0; padding: 2px;"><strong><?php echo ucwords($this->Master->FindGuestNameByGuestId($row['guest_id']));?></strong></p>
...
<p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding: 2px;"><strong>Cashier:</strong> <?php echo ucwords($_SESSION['user_name']);?></p>
...
<div style="width:10%; height:35px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 16px; margin: 0; padding:6px 6px 6px 5px; text-align:left;">Date</p></div>
<div style="width:20%; height:35px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 16px; margin: 0; padding:6px 6px 6px 5px;text-align:left;">Items</p></div>
<div style="width:30%; height:35px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 16px; margin: 0; padding:6px 6px 6px 5px;text-align:left;">Reference</p></div>
<div style="width:20%; height:35px; float:right;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 16px; margin: 0; padding:6px 6px 6px 5px;text-align:right;">Debit</p></div>
<div style="width:20%; height:35px;  float:right;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 16px; margin: 0; padding:6px 6px 6px 5px;text-align:right;">Credit</p></div> 
</div>

<!-- header code End -->

<div style="width:950px; border:1.3px solid #666666; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:10%; height:35px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > <?php echo date('d-m-Y', strtotime($row['payment_date']));?></p></div>
<div style="width:20%; height:35px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > Room</p></div>
<div style="width:30%; height:35px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > <?php echo $this->Master->TotalBookedRoomsByReservationId($row['reservation_id']);?> Room - <?php echo $this->Master->RoomTypeByReservationId($row['reservation_id']);?></p></div>
<div style="width:20%; height:35px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right; color:#000;" ><?php echo number_format($row['base_price'],2);?></p></div>
<div style="width:20%; height:35px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" > </p></div> 
</div>
...
?>
<div style="width:950px; border:1.3px solid #666666; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:10%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > <?php echo date('d-m-Y', strtotime($row['payment_date']));?></p></div>
<div style="width:20%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > Extra Bed </p></div>
<div style="width:30%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > <?php echo $this->Master->ExtraBedAllowed($row['reservation_id']);?> Bed</p></div>
<div style="width:20%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" ><?php echo number_format($row['extra_bed'],2);?></p></div>
<div style="width:20%; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" > </p></div> 
</div>
 <?php
}
?>
...
<div style="width:950px; border:1.3px solid #666666; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:10%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > <?php echo date('d-m-Y', strtotime($row['payment_date']));?></p></div>
<div style="width:20%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" >Luxury Tax</p></div>
<div style="width:30%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 12px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ><?php echo $this->Master->GetTaxValue(1)?>% <?php /*?>- On Room<?php */?></p></div>
<div style="width:20%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" ><?php echo number_format($row['tax1'],2);?></p></div>
<div style="width:20%; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" > </p></div> 
</div>
 <?php
}
...
<div style="width:950px; border:1.3px solid #666666; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:10%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > <?php echo date('d-m-Y', strtotime($row['payment_date']));?></p></div>
<div style="width:20%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" >Service Tax</p></div>
<div style="width:30%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 12px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > <?php echo $this->Master->GetTaxValue(2)?>% <?php /*?>[On Room]<?php */?></p></div>
<div style="width:20%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right; color:#000;" ><?php echo number_format($row['tax2'],2);?></p></div>
<div style="width:20%; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" > </p></div> 
</div>
 <?php
}
...
<div style="width:950px; border:1.3px solid #666666; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:10%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > <?php echo date('d-m-Y', strtotime($row['payment_date']));?></p></div>
<div style="width:20%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > Advance Payment</p></div>
<div style="width:30%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 12px; margin: 0;  color:#000;" ><?php echo $row['payment_mode']?><br /><span style="font-size:12px;"><b>Receipt No: </b><?php echo $row['receipt_no']?></span></p></div>
<div style="width:20%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" ></p></div>
<div style="width:20%; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" > <?php echo number_format($row['advance_amount'])?></p></div> 
</div>
 <?php
}
?>
...
?>
<div style="width:950px; border:1.3px solid #666666; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:10%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > <?php echo date('d-m-Y', strtotime($row['fullpayment_date']));?></p></div>
<div style="width:20%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" >Food and Beverage</p></div>
<div style="width:30%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" >--</p></div>
<div style="width:20%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" ><?php echo number_format($row['fb_price_plain'],2);?></p></div>
<div style="width:20%; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" > </p></div> 
</div>
 <?php
}
...
<div style="width:950px; border:1.3px solid #666666; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:10%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > <?php echo date('d-m-Y', strtotime($row['fullpayment_date']));?></p></div>
<div style="width:20%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" >VAT</p></div>
<div style="width:30%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ><?php echo $this->kt->GetVat();?> % <?php /*?>On F & B<?php */?></p></div>
<div style="width:20%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right; color:#000;" ><?php echo number_format($row['vat_fb'],2);?></p></div>
<div style="width:20%; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right; color:#000;" > </p></div> 
</div>
 <?php
}
...
<div style="width:950px; border:1.3px solid #666666; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:10%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > <?php echo date('d-m-Y', strtotime($row['fullpayment_date']));?></p></div>
<div style="width:20%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" >SAT</p></div>
<div style="width:30%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ><?php echo $this->kt->GetSat();?> % <?php /*?>On F & B<?php */?></p></div>
<div style="width:20%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right; color:#000;" ><?php echo number_format($row['sat_fb'],2);?></p></div>
<div style="width:20%; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" > </p></div> 
</div>
 <?php
}
...
<div style="width:950px; border:1.3px solid #666666; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:10%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > <?php echo date('d-m-Y', strtotime($row['fullpayment_date']));?></p></div>
<div style="width:20%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" >Service Charge</p></div>
<div style="width:30%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" > <?php echo $this->Master->GetTaxValue(4)?>% <?php /*?>- On Bill<?php */?></p></div>
<div style="width:20%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" ><?php echo number_format($row['service_charge'],2);?></p></div>
<div style="width:20%; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" > </p></div> 
</div>
 <?php
}
...
<div style="width:950px; border:1.3px solid #666666; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:10%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ><?php echo date('d-m-Y', strtotime($row['fullpayment_date']));?></p></div>
<div style="width:20%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" >Final Payment <span style="font-size:10px;">(<?php echo $row['fullpayment_mode'];?>)</span></p></div>
<div style="width:30%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" >--</p></div>
<div style="width:20%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" ></p></div>
<div style="width:20%; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" > <?php echo number_format($row['final_amount'],2);?></p></div> 
</div>
...
<div style="width:10%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ></p></div>
<div style="width:20%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ></p></div>
<div style="width:30%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ><b>Total</b></p></div>
<div style="width:20%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" ><?php echo number_format($this->total_amt_to_be_paid($row['base_price'],$row['extra_bed'],$row['tax1'],$row['tax2'],$row['fb_price_plain'],$row['vat_fb'],$row['sat_fb'],$row['service_charge']),2);?> INR</p></div>
<div style="width:20%; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" ></p></div> 
</div>
...
<div style="width:10%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ></p></div>
<div style="width:20%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ></p></div>
<div style="width:30%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ><b>Round Off:</b></p></div>
<div style="width:20%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" ><?php echo number_format(round($row['total_amount']+$row['discount']),2)?> INR</p></div>
<div style="width:20%; height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" > <?php echo number_format($row['total_paid_amount'],2)?> INR</p></div> 
</div>

<div style="width:950px; border:1.3px solid #666666; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:10% height: 30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ></p></div>
<div style="width:20% height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ></p></div>
<div style="width:30%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 267px;float:left; color:#000;" ><b>Discount</b></p></div>
<div style="width:20%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" ></p></div>
<div style="width:20%; height:30px;  float:right;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000; " align="right"> <?php echo number_format($row['discount'],2)?> INR</p></div> 
</div>
<div style="width:950px; border:2px solid #000000; height:30px; border-left:none; border-right:none; border-top:none;">
<div style="width:10%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ></p></div>
<div style="width:20%; height:30px;float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ></p></div>
<div style="width:30%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 6px;float:left; color:#000;" ><b>Balance Due</b></p></div>
<div style="width:20%; height:30px; float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right;  color:#000;" > <?php echo number_format(round($row['remain_amount']),2)?> INR</p></div>
<div style="width:20% height:30px;  float:left;"><p style="font-family:Arial, Helvetica, sans-serif;font-size: 13px; margin: 0; padding:6px 6px 6px 0px; float:right; color:#000;" > </p></div> 
</div>
