...
class MasterBanquetClass
{
      ...
      <div class="col-md-8">
       <div class="block-flat">
          ...
          <div class="content">
                            ...
                            <div class="col-sm-8">
                            <label>Banquet</label> 
                            <input type="text" name="banquet" class="form-control" required placeholder="Type something" />
                            </div>
                             </div>
    ...
    padding-bottom: 20px;">
			...
			extract($_POST);
						...
						/*Start Server Side Validation from here it works when javascript validation is failed*/
								$return =true;
						if($this->Form->ValidField($banquet,'empty','Please Enter Banquet')==false)
							$return =false;
						...
						if($return){
							...
							$insert_sql_array['banquet'] = $this->banquet;
							$insert_sql_array['status'] = '1';
							$insert_sql_array['deleted'] = '1';
							
						    $this->db->insert(HMS_BANQUET_TYPE,$insert_sql_array);
							
							$_SESSION['msg'] = 'Banquet has been Successfully Added';
	...
	function BanquetValuesManagement()
	{
		...
		?>
				...
				<div class="col-md-12">
					<div class="block-flat">
                    <a href="banquet.php?index=new_type" class="btn btn-primary btn-flat" style="float:right;">Add New</a>
						<div class="header">
						...
						<div class="content">
							<div class="table-responsive">
								<table class="table table-bordered" id="datatable" >
									...
									<tbody>
                                    <?php
				$sql="select * from ".HMS_BANQUET_TYPE." where deleted=1";
				...
				if($cnt>0)
				{
							...
							?>
										...
										<tr class="odd gradeX">
											...
											<td class="center"><div class="btn-group"><button class="btn btn-default btn-xs" type="button">Actions</button><button data-toggle="dropdown" class="btn btn-xs btn-primary dropdown-toggle" type="button"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button><ul role="menu" class="dropdown-menu pull-right"><li><a href="banquet.php?index=edit_source_Type&sourceId=<?php echo $row['id'];?>" title="Edit">Edit</a></li>
                                       
                                            <li class="divider"></li><li> <a  href="javascript: void(0);" title="Remove" onClick="javascript: if(confirm('Do u want to delete this Banquet?')) { Banquet_obj.deletebanquet('<?php echo $row['id'];?>',{}) };">Remove</a></li></ul></div></td>
										</tr>
										<?php 
							$x++;
							}
				...
				else
				{
					?>
                   					 <tr class="odd gradeX">
											<td colspan="5"><h4>Sorry! No Banquet Available</h4></td>
	...
	function deletebanquet($id)
	{
		    ...
		    $this->db->update(HMS_BANQUET_TYPE,$update_array1,'id',$id);
			
			/*End deleting all related rooms related with room type Id*/
			
			
			
			$_SESSION['msg']='Banquet has been Deleted successfully';
	...
	{
				$sql="select * from ".HMS_BANQUET_TYPE." where id ='".$sourceId."'";
				$result = $this->db->query($sql,__FILE__,__LINE__);
      ...
      <div class="col-md-8">
       <div class="block-flat">
          ...
          <div class="content">
                            ...
                            <div class="col-sm-8">
                            <label>Banquet</label> 
                            <input type="text" name="banquet" value="<?php echo $row['banquet']?>" class="form-control" required placeholder="Type something" />
                            </div>
                             </div>
    ...
    padding-bottom: 20px;">
			...
			extract($_POST);
						...
						if($return){
							...
							$update_sql_array['banquet'] = $this->banquet;
							 $this->db->update(HMS_BANQUET_TYPE,$update_sql_array,'id',$sourceId);
							$_SESSION['msg'] = 'Banquet has been Successfully Updated.';
