...
<div class="container-fluid" id="pcont">
	...
	<?php $notice_obj->notify();?>
        ...
        {
        case 'View_User':
       	  $user_obj->SearchUser($name,$username,$contact,$user_type,$user_status);
          $user_obj->ViewUser($user_id);
		   //$user_obj->Advance_Search($first_name,$last_name,$phone,$arrival,$departure,$room_type_id);
        break;
        default :
          $user_obj->SearchUser($name,$username,$contact,$user_type,$user_status);
          $user_obj->Show_all_user($name,$username,$contact,$user_type,$user_status);
        break;
        }
        ?>
