...
?>
	...
	{
	case 'sales' :
    $report_obj->SalesBanquetPaxWithHallSearch($banquet_type,$report_date);
	break;
	
	default:
	$report_obj->SalesBanquetPaxWithHallSearch($banquet_type,$report_date);
	$report_obj->SalesBanquetWithPaxReport($banquet_type,$report_date);
	break;
	}
